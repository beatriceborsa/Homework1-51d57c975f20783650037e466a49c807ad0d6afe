...
export default {
    ...
    methods: {
        ...
        async userProfile() {
            try {
                let response = await this.$axios.get("/users/" + this.$route.params.username + "/userprofile", {
                    headers: {
        ...
        async userPhotos() {
            try {
                let response = await this.$axios.get("/users/" + this.$route.params.username + "/phuser", {
                    headers: {
                        Authorization: "Bearer " + localStorage.getItem("token")
                    }
                })
        ...
        async unbanUser(username) {
            try {
                let response = await this.$axios.get("/users/" + username + "/userban", {
                    headers: {
                        Authorization: "Bearer " + localStorage.getItem("token")
                    }
                })
